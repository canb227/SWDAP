...
package org.swdapParser.swdestinydbParser;

import java.lang.reflect.Type;

import org.swdapModel.Card;
import org.swdapModel.CardDie;
import org.swdapModel.Set;
...
//    e = obj.get("set_code");
//    if (e != null && !e.isJsonNull()) {
//      card.setSet(Set.fromString(e.getAsString()));
//    } else {
//      card.setSet(Set.UNKNOWN);
//    }
